...
import static com.pa.common.Validators.validateOnlyNumbersUsed;
...
public class register extends JFrame {
	...
	public register() {
		...
		comboBoxRole.setBounds(130, 147, 119, 20);
		cpRegister.add(comboBoxRole);
		
		passwordField = new JPasswordField();
		passwordField.setBounds(130, 172, 119, 20);
